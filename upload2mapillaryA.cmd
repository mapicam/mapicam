...
@echo . ############################################
@echo .
@echo . C:\ffmpeg\bin\mapillary_tools.exe process_and_upload --advanced --import_path "A/adjusted" --user_name velmyshanovnyi --flag_duplicates --duplicate_distance 0.5
@echo .
@echo . ############################################
@echo .
...
C:\ffmpeg\bin\mapillary_tools.exe process_and_upload --advanced --import_path "A/adjusted" --user_name velmyshanovnyi --flag_duplicates --duplicate_distance 0.5

@echo .
@echo . ##### VSE ZALYLOSIA #####
@echo . 
@echo . C:\ffmpeg\bin\mapillary_tools.exe process_and_upload --advanced --import_path "A/adjusted" --user_name velmyshanovnyi --number_threads 1 --max_attempts 2 --verbose --rerun --flag_duplicates --duplicate_distance 0.5
@echo .
